declare module 'autonumeric' {
    export default class AutoNumeric {
        constructor(domElement: HTMLElement | string, userOptions: options);
        ...
        //methods
        set: (value: string | number, options?: options, saveState?: boolean) => void;
        setUnformatted: (value: string | number, options?: options) => void;
    ...
    export interface options {
        ...
        caretPositionOnFocus?: 'start' | 'end' | 'decimalLeft' | 'decimalRight' | 'doNoForceCaretPosition';
        ...
        defaultValueOverride?: null | string;
